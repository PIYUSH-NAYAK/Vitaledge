    ...
    <div className='min-h-screen bg-black flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8'>
      <div className='max-w-md w-full space-y-8 bg-gray-900 p-10 rounded-xl shadow-md'>
        <div className='text-center'>
          ...
          <p className='mt-2 text-sm text-gray-400'>Enter your email below to login to your account.</p>
        </div>
        <div className='space-y-4'>
          <InputControls label='Email' placeholder='Enter your email' />
          <InputControls label='Password' placeholder='Enter your password' type='password' />
        </div>
        ...
        <div className='mt-6 text-center'>
          ...
          <Link to='/forgot-password' className='text-sm text-teal-500 hover:text-teal-400 underline'>
