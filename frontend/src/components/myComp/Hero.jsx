    ...
    >
      <div className="container relative" ref={parallaxRef}>
        <div className="relative z-1 max-w-[62rem] mx-auto text-center mb-[3.875rem] md:mb-20 lg:mb-[6.25rem]">
          ...
          <Button href="/medicines" white>
            Get started
          </Button>
        </div>
        <div className="relative max-w-[24rem] mx-auto md:max-w-[30rem] lg:max-w-5xl xl:mb-24">
          <div className="relative z-1 p-1 rounded-2xl bg-conic-gradient">
            {/* <div className="relative bg-n-8 rounded-[1rem]"> */}
              {/* <div className="h-[1.4rem] bg-n-10 rounded-t-[0.9rem]" /> */}

              <div className="aspect-[4/3] rounded-[0.9rem] overflow-hidden md:aspect-[688/490] lg:aspect-[1024/490]">
                <img
                  src="./vital1.jpg"
