...
export default function Cart ({showModal, toggle}) {
  ...
  return (
    showModal && (
      <div className="flex-col flex items-center fixed inset-0 left-1/4 bg-white dark:bg-black gap-8  p-10  text-black dark:text-white font-normal uppercase text-sm mt-20 overflow-y-auto max-h-screen">
        <ToastContainer />
